...
public class TudiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public TudiCollectionEntity() {

	}

	public TudiCollectionEntity(T t) {
		try {
     ...
     * 类型
     */
    @TableField(value = "tudi_collection_types")
    ...
    public String toString() {
        return "TudiCollection{" +
            "id=" + id +
            ", tudiId=" + tudiId +
            ", yonghuId=" + yonghuId +
            ", tudiCollectionTypes=" + tudiCollectionTypes +
