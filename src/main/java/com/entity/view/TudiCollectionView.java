...
public class TudiCollectionView extends TudiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String tudiCollectionValue;
	...
	public TudiCollectionView() {

	}

	public TudiCollectionView(TudiCollectionEntity tudiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, tudiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getTudiCollectionValue() {
				return tudiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setTudiCollectionValue(String tudiCollectionValue) {
				this.tudiCollectionValue = tudiCollectionValue;
			}
