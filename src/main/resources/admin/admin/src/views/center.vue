<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='农民名称' prop="shangjiaName">
               <el-input v-model="ruleForm.shangjiaName"  placeholder='农民名称' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'" label='头像' prop="shangjiaPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='农民信用类型' prop="shangjiaXingjiTypes">
                 <el-select v-model="ruleForm.shangjiaXingjiTypes" disabled placeholder='请选择农民信用类型'>
                     <el-option
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='shangjia'"  label="农民介绍" prop="shangjiaContent">
                 <editor
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.shangjiaXingjiTypes)&& 'shangjia'==this.flag){
                             this.$message.error('农民信用类型不能为空');
                             return
                         }

                         if((!this.ruleForm.shangjiaContent)&& 'shangjia'==this.flag){
                             this.$message.error('农民介绍不能为空');
                             return
                         }
