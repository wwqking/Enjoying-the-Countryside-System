    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="建议标题" prop="shangjiajianyiName">
                       <el-input v-model="ruleForm.shangjiajianyiName"
                                 placeholder="建议标题" clearable  :readonly="ro.shangjiajianyiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="建议标题" prop="shangjiajianyiName">
                           <el-input v-model="ruleForm.shangjiajianyiName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="建议详情" prop="shangjiajianyiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shangjiajianyiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiajianyiContent" label="建议详情" prop="shangjiajianyiContent">
                            <span v-html="ruleForm.shangjiajianyiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shangjiajianyi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shangjiajianyiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
