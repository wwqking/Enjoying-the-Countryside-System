        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="农民名称" prop="shangjiaName">
                       <el-input v-model="ruleForm.shangjiaName"
                                 placeholder="农民名称" clearable  :readonly="ro.shangjiaName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangjiaPhoto" label="头像" prop="shangjiaPhoto">
                        <file-upload
                            tip="点击上传头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaPhoto" label="头像" prop="shangjiaPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="农民信用类型" prop="shangjiaXingjiTypes">
                        <el-select v-model="ruleForm.shangjiaXingjiTypes" :disabled="ro.shangjiaXingjiTypes" placeholder="请选择农民信用类型">
                            <el-option
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="农民介绍" prop="shangjiaContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaContent" label="农民介绍" prop="shangjiaContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaName: [
                              { required: true, message: '农民名称不能为空', trigger: 'blur' },
                          ],
                   shangjiaPhone: [
                   ...
                   shangjiaXingjiTypes: [
                              { required: true, message: '农民信用类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangjiaContent: [
                              { required: true, message: '农民介绍不能为空', trigger: 'blur' },
                          ],
                   shangjiaDelete: [
