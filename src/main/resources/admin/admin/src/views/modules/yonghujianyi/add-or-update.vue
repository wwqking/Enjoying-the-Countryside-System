    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="建议标题" prop="yonghujianyiName">
                       <el-input v-model="ruleForm.yonghujianyiName"
                                 placeholder="建议标题" clearable  :readonly="ro.yonghujianyiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="建议标题" prop="yonghujianyiName">
                           <el-input v-model="ruleForm.yonghujianyiName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="建议详情" prop="yonghujianyiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yonghujianyiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghujianyiContent" label="建议详情" prop="yonghujianyiContent">
                            <span v-html="ruleForm.yonghujianyiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yonghujianyiName: false,
                    yonghujianyiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                rules: {
                   ...
                   yonghujianyiContent: [
                              { required: true, message: '建议详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yonghujianyi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yonghujianyiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
