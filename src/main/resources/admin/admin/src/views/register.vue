<template>
    <div style="backgroundImage: url('/lexiangtianyuan/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">乐享田园系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="农民名称" class="input" v-if="tableName=='shangjia'">
                            <el-input v-model="ruleForm.shangjiaName" autocomplete="off" placeholder="农民名称"  />
                        </el-form-item>
