...
var centerMenu = [
    ...
    ,{
        name: '土地收藏',
        url: '../tudiCollection/list.html'
    }
    ,{
        name: '土地租赁订单',
        url: '../tudiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '土地',
        url: './pages/tudi/list.html'
    },

]

var adminurl =  "http://localhost:8080/lexiangtianyuan/admin/dist/index.html#/login";
